...
\begin{lstlisting}[language=HTML, caption=Ejemplo de llamada de entidad, captionpos=b, label=lst:aframe-entity]
  <html>
    <head>
      <script src="https://aframe.io/releases/1.6.0/aframe.min.js"></script>
...
\begin{lstlisting}[language=HTML, caption=Ejemplo de creacion de entidad, captionpos=b, label=lst:aframe-entity-creation]
...
Gracias a que HTML es una tecnologia extensible, gracias a tecnologias como A-Frame o WebXR han sido posibles de utilizar ya que son extensiones de HTML. WebXR permitio poder trabajar con entornos VR desde el navegador mientras que A-Frame fue el eje central 
del proyecto, donde se estructuro la escena.
...
Para este proyecto formo un papel crucial, ya que los distintos componentes de A-Frame que se crearon para el funcionamiento del proyecto fueron programados mediante JavaScript.
